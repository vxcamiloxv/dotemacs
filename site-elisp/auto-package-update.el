...
(defcustom auto-package-update-custom-list 'default
...
(defun apu--packages-to-install ()
  ...
  ;;(-filter 'apu--package-out-of-date-p distopico-packages))
...
(defun auto-package-update-now ()
  ...
  (let ((installation-report (apu--safe-install-packages distopico-packages)))
