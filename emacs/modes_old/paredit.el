...
(defvar my-nasty-paredit-keybindings-remappings
  '(("M-s" "s-s" paredit-splice-sexp)
    ("s-<up>" "s-<up>" paredit-splice-sexp-killing-backward)
    ("s-<down>" "s-<down>" paredit-splice-sexp-killing-forward)
    ("s-<right>" "s-<right>" paredit-forward-slurp-sexp)
    ("s-<left>" "s-<left>" paredit-forward-barf-sexp)
